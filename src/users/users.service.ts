import { BadRequestException, Injectable, NotFoundException, ParseIntPipe, Query } from '@nestjs/common';
  ...
  async update(id: number, updateUserDto: UpdateUserDto) {
    ...
    if (data.email) {
      ...
      if (existingUser && existingUser.id !== id) {
        return {status: "fail", message: "Email is already in use by another account" };
      }
    }
    return {
      status: "success", 
